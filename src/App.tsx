      ...
      <section id="download" className="bg-linear-to-r from-purple-600 to-indigo-700 dark:from-purple-900 dark:to-indigo-900 text-white py-20 px-4 text-center">
        <div className="container mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            <a href={import.meta.env.VITE_APP_APK_DOWNLOAD_URL} download className="bg-white text-purple-700 dark:text-purple-900 px-10 py-4 rounded-full text-xl font-bold hover:bg-gray-200 transition duration-300 ease-in-out shadow-lg">
